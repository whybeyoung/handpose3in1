...
@file: wrapper.py
@time: 2022-09-03 09:41:20.346690
@project: handpose
@project: ./
"""
...
from handpose_detect import HandPoseDetector
...
class Wrapper(WrapperBase):
    ...
    def wrapperInit(self, config: {}) -> int:
        ...
        Wrapper.hand_model = HandDetector("/workspace/handpose3in1/models/hand/hand_m.onnx","hd")
        Wrapper.handpose_model = None
        #Wrapper.items_model = ItemsDetector("yolov5m")
    ...
    def wrapperOnceExec(cls, params: {}, reqData: DataListCls) -> Response:
        ...
        print(type(img))
        dtype = reqData.list[0].type
        #  hand infer
        res = Wrapper.hand_model.detect(img)
